...
from plugins.modules import ibm_schematics_agents_info
...
def mock_operations(func):
    def wrapper(self):
        ...
        self.assertIsNone(ibm_schematics_agents_info.MISSING_IMPORT_EXC)

        # Set-up mocks for each operation.
        self.read_patcher = patch('plugins.modules.ibm_schematics_agents_info.SchematicsV1.get_agent')
...
class TestAgentModuleInfo(ModuleTestCase):
    """
    Test class for Agent module testing.
    """

    @mock_operations
    def test_read_ibm_schematics_agents_success(self):
        ...
        with self.assertRaises(AnsibleExitJson) as result:
            ...
            ibm_schematics_agents_info.main()
    ...
    def test_read_ibm_schematics_agents_failed(self):
        ...
        self.read_mock.side_effect = ApiException(400, message='Read ibm_schematics_agents error')
        ...
        self.assertEqual(result.exception.args[0]['msg'], 'Read ibm_schematics_agents error')
