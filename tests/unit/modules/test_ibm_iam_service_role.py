...
from plugins.modules import ibm_iam_service_role
...
def mock_operations(func):
    def wrapper(self):
        ...
        self.assertIsNone(ibm_iam_service_role.MISSING_IMPORT_EXC)

        # Set-up mocks for each operation.
        self.read_patcher = patch('plugins.modules.ibm_iam_service_role.IamPolicyManagementV1.get_role')
        self.read_mock = self.read_patcher.start()
        self.create_patcher = patch('plugins.modules.ibm_iam_service_role.IamPolicyManagementV1.create_role')
        self.create_mock = self.create_patcher.start()
        self.update_patcher = patch('plugins.modules.ibm_iam_service_role.IamPolicyManagementV1.replace_role')
        self.update_mock = self.update_patcher.start()
        self.delete_patcher = patch('plugins.modules.ibm_iam_service_role.IamPolicyManagementV1.delete_role')
...
class TestRoleModule(ModuleTestCase):
    """
    Test class for Role module testing.
    """

    @mock_operations
    def test_read_ibm_iam_service_role_failed(self):
    ...
    @mock_operations
    def test_create_ibm_iam_service_role_success(self):
    ...
    @mock_operations
    def test_create_ibm_iam_service_role_failed(self):
        """Test the "create" path - failed."""
        self.read_mock.side_effect = ApiException(404)
        self.create_mock.side_effect = ApiException(400, message='Create ibm_iam_service_role error')
        ...
        self.assertEqual(result.exception.args[0]['msg'], 'Create ibm_iam_service_role error')
    ...
    @mock_operations
    def test_update_ibm_iam_service_role_success(self):
    ...
    @mock_operations
    def test_update_ibm_iam_service_role_failed(self):
        ...
        self.read_mock.return_value = DetailedResponseMock(resource)
        self.update_mock.side_effect = ApiException(400, message='Update ibm_iam_service_role error')
        ...
        self.assertEqual(result.exception.args[0]['msg'], 'Update ibm_iam_service_role error')
    ...
    @mock_operations
    def test_delete_ibm_iam_service_role_success(self):
    ...
    @mock_operations
    def test_delete_ibm_iam_service_role_not_exists(self):
    ...
    @mock_operations
    def test_delete_ibm_iam_service_role_failed(self):
        """Test the "delete" path - failed."""
        self.read_mock.return_value = DetailedResponseMock()
        self.delete_mock.side_effect = ApiException(400, message='Delete ibm_iam_service_role error')
        ...
        self.assertEqual(result.exception.args[0]['msg'], 'Delete ibm_iam_service_role error')
