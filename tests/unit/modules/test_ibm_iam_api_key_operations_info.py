...
from plugins.modules import ibm_iam_api_key_operations_info
...
def mock_operations(func):
    def wrapper(self):
        ...
        self.assertIsNone(ibm_iam_api_key_operations_info.MISSING_IMPORT_EXC)

        # Set-up mocks for each operation.
        self.read_patcher = patch('plugins.modules.ibm_iam_api_key_operations_info.IamIdentityV1.get_api_key')
...
class TestApiKeyModuleInfo(ModuleTestCase):
    """
    Test class for ApiKey module testing.
    """

    @mock_operations
    def test_read_ibm_iam_api_key_operations_success(self):
        ...
        with self.assertRaises(AnsibleExitJson) as result:
            ...
            ibm_iam_api_key_operations_info.main()
    ...
    def test_read_ibm_iam_api_key_operations_failed(self):
        ...
        self.read_mock.side_effect = ApiException(400, message='Read ibm_iam_api_key_operations error')
        ...
        self.assertEqual(result.exception.args[0]['msg'], 'Read ibm_iam_api_key_operations error')
