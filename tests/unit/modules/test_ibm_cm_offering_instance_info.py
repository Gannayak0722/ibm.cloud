...
from plugins.modules import ibm_cm_offering_instance_info
...
def mock_operations(func):
    def wrapper(self):
        ...
        self.assertIsNone(ibm_cm_offering_instance_info.MISSING_IMPORT_EXC)

        # Set-up mocks for each operation.
        self.read_patcher = patch('plugins.modules.ibm_cm_offering_instance_info.CatalogManagementV1.get_offering_instance')
...
class TestOfferingInstanceModuleInfo(ModuleTestCase):
    """
    Test class for OfferingInstance module testing.
    """

    @mock_operations
    def test_read_ibm_cm_offering_instance_success(self):
        ...
        with self.assertRaises(AnsibleExitJson) as result:
            ...
            ibm_cm_offering_instance_info.main()
    ...
    def test_read_ibm_cm_offering_instance_failed(self):
        ...
        self.read_mock.side_effect = ApiException(400, message='Read ibm_cm_offering_instance error')
        ...
        self.assertEqual(result.exception.args[0]['msg'], 'Read ibm_cm_offering_instance error')
