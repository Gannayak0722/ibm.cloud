...
DOCUMENTATION = r'''
---
module: ibm_iam_access_group_template_version_info
short_description: Manage C(iam_access_group_template_version) for IAM Access Groups.
author: 
  - Gannayak Pabra (@Gannayak0722)
  - Kavya Handadi (@kavya498)
version_added: "1.0.0"
description:
  - This module retrieves one or more C(iam_access_group_template_version) for IAM Access Groups.
requirements:
  - "IamAccessGroupsV2"
options:
  limit:
...
group_template_versions:
  description: "A list with all ListTemplateVersionResponse instances."
  type: list
  elements: 'dict'
  contains:
    name:
...
try:
    ...
    from ibm_platform_services.iam_access_groups_v2 import TemplateVersionsPager
...
def run_module():
    ...
    try:
        ...
        module.exit_json(group_template_versions=result)
