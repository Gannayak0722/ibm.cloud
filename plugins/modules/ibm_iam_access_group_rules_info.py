...
version_added: "1.0.0"
description:
  - This module retrieves one or more C(iam_access_group_rules) for IAM Access Groups.
requirements:
  - "IamAccessGroupsV2"
options:
  rule_id:
...
EXAMPLES = r'''
- name: Read ibm_iam_access_group_rules
  ibm_iam_access_group_rules_info:
    access_group_id: 'testString'
    rule_id: 'testString'
    transaction_id: 'testString'

- name: List ibm_iam_access_group_rules
  ibm_iam_access_group_rules_info:
    access_group_id: 'testString'
    transaction_id: 'testString'
'''
